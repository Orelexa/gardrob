...
export function getFriendlyErrorMessage(error: unknown, context: string): string {
    let rawMessage = 'Ismeretlen hiba történt.';
    ...
    if (rawMessage.includes("Unsupported MIME type")) {
        try {
            ...
            if (nestedMessage && nestedMessage.includes("Unsupported MIME type")) {
                ...
                return `A(z) '${mimeType}' fájltípus nem támogatott. Kérjük, használj PNG, JPEG vagy WEBP formátumot.`;
            }
        } catch (e) {
        ...
        return `Nem támogatott fájlformátum. Kérjük, tölts fel PNG, JPEG vagy WEBP formátumú képet.`;
    }
