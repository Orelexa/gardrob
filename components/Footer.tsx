...
const REMIX_SUGGESTIONS = [
  "Remix ötlet: Hozz létre egy megosztható lookbookot.",
  "Remix ötlet: Integrálj egy e-kereskedelmi API-t hasonló termékek kereséséhez.",
  "Remix ötlet: Adj hozzá kiegészítőket, mint kalapok, napszemüvegek vagy táskák.",
  "Remix ötlet: Hozz létre egy 'stíluspontszámot' az összeállításokhoz.",
  "Remix ötlet: Engedélyezd a felhasználóknak, hogy elmentsék kedvenc szettjeiket.",
  "Remix ötlet: Generálj különböző színváltozatokat a ruhákhoz.",
];
